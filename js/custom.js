jQuery('document').ready(function($) {	
	...
	/*=========================================*/	
		...
		$('.countdown').downCount({
			date: '12/14/2017 16:00:00', // Change this date and time
			offset: +10
		}, function () {
			alert('WOOT WOOT, Let\'s Go!');  // Finish Message
		});
	...
	var menu1 = ("#section1, #section2, #section3, #section4, #section5");
	var menu2 = (".home_area, #section2, #section3, #section4, #section5");
	var menu3 = (".home_area, #section1, #section3, #section4, #section5");
	var menu4 = (".home_area, #section1, #section2, #section4, #section5");
	var menu5 = (".home_area, #section1, #section2, #section3, #section5");
	var menu6 = (".home_area, #section1, #section2, #section3, #section4");
	...
	$(".nongchao").hover(function() {
		$(menu6).hide(0, function() {
			$("#section5").show(0);
		});
	});
	...
	$(".nongchao").mouseenter(function() {
		$("#section5").addClass('animated fadeIn');
	});	
	$(".nongchao").mouseleave(function() {
		$("#section5").removeClass('animated fadeIn');
	});
	/*=========================================*/
